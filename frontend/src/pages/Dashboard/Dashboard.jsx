...
// Confidence is always a 0-100 percentage. Clamping here is a defensive
// last line of defense on the frontend, in addition to the backend
// clamping every value at write- and read-time, so this figure can
// never render as something like "1639.36%".
        ...
        >
          ...
          <div className="analytics-summary-card">
            ...
            <h2 className="summary-card-metric">
              {clampPercent(summary.average_confidence).toFixed(2)}%
            </h2>
          </div>
              ...
              <tbody>
                {recent.map((item) => (
                  <tr key={item.id}>
                    ...
                    <td className="metric-cell-token">
                      {clampPercent(item.confidence).toFixed(2)}%
                    </td>
